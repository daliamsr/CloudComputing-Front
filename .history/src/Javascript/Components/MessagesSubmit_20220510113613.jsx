...
function MessagesSubmit() {
    ...
    const handleMessageSend = async (e) => {
        ...
        try {
          let messageContent = await axios.get(`${process.env.REACT_APP_API_URL}/utils/labels`,{params:{link: pictureLink}});
          ...
          let response = await axios.post(
                `${process.env.REACT_APP_API_URL}/messages/foreign`,
                {
                    ...
                    receiverMail,
                    messageContent: messageContent.data.labels.toString()
                });
