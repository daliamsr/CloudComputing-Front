    ...
    const handleMessageSend = async (e) => {
        ...
        try {
          let pictureLabels = await axios.get(
            `${process.env.REACT_APP_API_URL}/utils/labels`,
            {
               link: 'https://media.cntraveler.com/photos/5eb1cdd479397e1bac70bdf3/master/w_4032,h_2688,c_limit/Crater-Lake-GettyImages-1158150928.jpg'
            });
            console.log(pictureLabels);
